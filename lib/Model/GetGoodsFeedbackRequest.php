...
class GetGoodsFeedbackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['model_ids']) && (count($this->container['model_ids']) < 1)) {
            $invalidProperties[] = "invalid value for 'model_ids', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets model_ids
     *
     * @param int[]|null $model_ids Фильтр по идентификатору модели товара.  Получить идентификатор модели можно с помощью одного из запросов:  * [POST businesses/{businessId}/offer-mappings](../../reference/business-assortment/getOfferMappings.md);  * [POST businesses/{businessId}/offer-cards](../../reference/content/getOfferCardsContentStatus.md).
     *
     * @return self
     * @deprecated
     */
    public function setModelIds($model_ids)
    {
        ...
        if (!is_null($model_ids) && (count($model_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $model_ids when calling GetGoodsFeedbackRequest., number of items must be greater than or equal to 1.');
        }

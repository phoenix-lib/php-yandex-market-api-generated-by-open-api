...
class ParameterValueDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets value_id
     *
     * @param int|null $value_id Идентификатор значения.  Обязательно указывайте идентификатор, если передаете значение из перечня допустимых значений, полученного от Маркета.  Передавайте вместе с `value`.  Только для характеристик типа `ENUM`.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Значение.  Для характеристик типа `ENUM` передавайте вместе с `valueId`.
     *
     * @return self
     */

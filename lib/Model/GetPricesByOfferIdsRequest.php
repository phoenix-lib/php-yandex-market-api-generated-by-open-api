...
class GetPricesByOfferIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets offer_ids
     *
     * @param string[]|null $offer_ids Список :no-translate[SKU].  {% note warning \"Такой список возвращается только целиком\" %}  Если вы запрашиваете информацию по конкретным :no-translate[SKU], не заполняйте:  * `page_token` * `limit`  {% endnote %}   
     *
     * @return self
     */

...
class ReturnDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets creation_date
     *
     * @param \DateTime|null $creation_date Дата создания невыкупа или возврата клиентом.  Формат даты: :no-translate[ISO 8601] со смещением относительно :no-translate[UTC].
     *
     * @return self
     */
     ...
     * Sets update_date
     *
     * @param \DateTime|null $update_date Дата обновления невыкупа или возврата.  Формат даты: :no-translate[ISO 8601] со смещением относительно :no-translate[UTC].
     *
     * @return self
     */

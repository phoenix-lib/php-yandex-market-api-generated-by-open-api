...
class OrderItemDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets price
     *
     * @param float $price Цена на товар в валюте заказа без учета вознаграждения продавцу за скидки по промокодам, купонам и акциям (параметр `subsidies`).  Включает НДС.
     *
     * @return self
     */
     ...
     *
     * @param string|null $partner_warehouse_id Идентификатор склада в системе магазина, на который сформирован заказ.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets promos
     *
     * @param \OpenAPI\Client\Model\OrderItemPromoDTO[]|null $promos Информация о вознаграждениях продавцу за скидки на товар по промокодам, купонам и акциям.
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param \OpenAPI\Client\Model\OrderItemDetailDTO[]|null $details {% note warning \"Для получения информации о невыкупах и возвратах используйте [GET campaigns/{campaignId}/returns](../../reference/orders/getReturns.md).\" %}     {% endnote %}  Информация о невыкупленных или возвращенных товарах в заказе.
     *
     * @return self
     * @deprecated
     */

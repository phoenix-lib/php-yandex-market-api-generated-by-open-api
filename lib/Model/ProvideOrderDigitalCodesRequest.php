...
class ProvideOrderDigitalCodesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\OrderDigitalItemDTO[] $items Список проданных товаров.  Если в заказе есть несколько **одинаковых** товаров (например, несколько ключей к одной и той же подписке), передайте ключи в виде массива к этому товару. Параметр `id` у этих элементов должен быть один и тот же.
     *
     * @return self
     */

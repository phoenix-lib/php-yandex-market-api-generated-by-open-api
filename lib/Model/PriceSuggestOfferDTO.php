...
class PriceSuggestOfferDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['price_suggestion']) && (count($this->container['price_suggestion']) < 1)) {
            $invalidProperties[] = "invalid value for 'price_suggestion', number of items must be greater than or equal to 1.";
        }
    ...
    public function setPriceSuggestion($price_suggestion)
    {
        ...
        if (!is_null($price_suggestion) && (count($price_suggestion) < 1)) {
            throw new \InvalidArgumentException('invalid length for $price_suggestion when calling PriceSuggestOfferDTO., number of items must be greater than or equal to 1.');
        }

...
class GetChatInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Дата и время создания чата.  Формат даты: :no-translate[ISO 8601] со смещением относительно :no-translate[UTC].
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at Дата и время последнего сообщения в чате.  Формат даты: :no-translate[ISO 8601] со смещением относительно :no-translate[UTC].
     *
     * @return self
     */

...
class ParcelBoxLabelDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets weight
     *
     * @param string $weight {% note warning \"Параметр устарел и будет отключен 19.10.2026.\" %}     {% endnote %}  Общая масса всех товаров в заказе.  Возвращается в формате `weight кг`.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param string $delivery_service_id Идентификатор службы доставки. Информацию о службе доставки можно получить с помощью запроса [GET delivery/services](../../reference/delivery-services/getDeliveryServices.md).
     *
     * @return self
     */

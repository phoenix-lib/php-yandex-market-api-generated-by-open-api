...
/**
 * PartnerWarehouseOfferDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class PartnerWarehouseOfferDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerWarehouseOfferDTO';
    ...
    */
    ...
    public function setOfferId($offer_id)
    {
        ...
        if ((mb_strlen($offer_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling PartnerWarehouseOfferDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($offer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling PartnerWarehouseOfferDTO., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?=.*\\S.*)[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$offer_id when calling PartnerWarehouseOfferDTO., must conform to the pattern /^(?=.*\\S.*)[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }

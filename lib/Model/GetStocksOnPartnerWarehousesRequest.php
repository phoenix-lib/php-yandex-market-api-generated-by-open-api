...
/**
 * GetStocksOnPartnerWarehousesRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GetStocksOnPartnerWarehousesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetStocksOnPartnerWarehousesRequest';
    ...
    */
     ...
     *
     * @param int $partner_warehouse_id Идентификатор склада.  Чтобы узнать идентификатор склада, воспользуйтесь запросом [POST v3/businesses/{businessId}/warehouses](../../reference/warehouses/getPartnerWarehouses.md).
     *
     * @return self
     */
    public function setPartnerWarehouseId($partner_warehouse_id)
    {
        ...
        if (($partner_warehouse_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $partner_warehouse_id when calling GetStocksOnPartnerWarehousesRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets offer_ids
     *
     * @param string[]|null $offer_ids Фильтр по вашим SKU товаров.  Возвращается информация об остатках всех переданных SKU, включая товары в архиве.  {% note warning \"Такой список возвращается только целиком\" %}  Если вы запрашиваете информацию по конкретным SKU, не заполняйте:  * `pageToken` * `limit` * `archived`  {% endnote %}   
     *
     * @return self
     */
    public function setOfferIds($offer_ids)
    {
        ...
        if (!is_null($offer_ids) && (count($offer_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $offer_ids when calling GetStocksOnPartnerWarehousesRequest., number of items must be less than or equal to 500.');
        }
        if (!is_null($offer_ids) && (count($offer_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_ids when calling GetStocksOnPartnerWarehousesRequest., number of items must be greater than or equal to 1.');
        }

...
class GeneratePricesReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets business_id
     *
     * @param int|null $business_id Идентификатор кабинета.  В большинстве случаев обязателен. Не указывается, если задан `campaignId`.
     *
     * @return self
     */

...
class ModelOfferDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets price
     *
     * @param float|null $price Цена предложения без скидки, которую получает покупатель при оплате через :no-translate[Yandex Pay].
     *
     * @return self
     */
     ...
     * Sets shipping_cost
     *
     * @param float|null $shipping_cost Стоимость доставки товара в регион:  * `0` — платить за доставку не нужно. * `-1` — магазин не осуществляет доставку этого товара (самовывоз).  Если стоимость доставки неизвестна, параметр не выводится.
     *
     * @return self
     */
     ...
     * Sets in_stock
     *
     * @param int|null $in_stock {% note warning \"Не используйте этот параметр.\" %}     {% endnote %}
     *
     * @return self
     * @deprecated
     */

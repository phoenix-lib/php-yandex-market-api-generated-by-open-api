...
/**
 * GetGoodsFeedbackUrbanadsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GetGoodsFeedbackUrbanadsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetGoodsFeedbackUrbanadsRequest';
    ...
    */
    ...
    public function setFeedbackIds($feedback_ids)
    {
        ...
        if (!is_null($feedback_ids) && (count($feedback_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $feedback_ids when calling GetGoodsFeedbackUrbanadsRequest., number of items must be less than or equal to 50.');
        }
        if (!is_null($feedback_ids) && (count($feedback_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $feedback_ids when calling GetGoodsFeedbackUrbanadsRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setRatingValues($rating_values)
    {
        ...
        if (!is_null($rating_values) && (count($rating_values) > 5)) {
            throw new \InvalidArgumentException('invalid value for $rating_values when calling GetGoodsFeedbackUrbanadsRequest., number of items must be less than or equal to 5.');
        }
        if (!is_null($rating_values) && (count($rating_values) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rating_values when calling GetGoodsFeedbackUrbanadsRequest., number of items must be greater than or equal to 1.');
        }

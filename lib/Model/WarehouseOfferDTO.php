...
class WarehouseOfferDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at Дата и время последнего обновления информации об остатках.  Формат даты и времени: :no-translate[ISO 8601] со смещением относительно :no-translate[UTC]. Например, `2023-11-21T00:42:42+03:00`.
     *
     * @return self
     */

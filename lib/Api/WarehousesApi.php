...
class WarehousesApi
{
    ...
    public function getPartnerWarehousesRequest($business_id, $page_token = null, $limit = 15, $get_partner_warehouses_request = null, string $contentType = self::contentTypes['getPartnerWarehouses'][0])
    {
        ...
        if ($business_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$business_id" when calling WarehousesApi.getPartnerWarehouses, must be bigger than or equal to 1.');
        }
        

        if ($limit !== null && $limit > 30) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling WarehousesApi.getPartnerWarehouses, must be smaller than or equal to 30.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling WarehousesApi.getPartnerWarehouses, must be bigger than or equal to 1.');
        }
    ...
    public function updateWarehouseModelStatusRequest($business_id, $update_warehouse_model_status_request, string $contentType = self::contentTypes['updateWarehouseModelStatus'][0])
    {
        ...
        if ($business_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$business_id" when calling WarehousesApi.updateWarehouseModelStatus, must be bigger than or equal to 1.');
        }

...
class LaasApi
{
    ...
    public function generateOfferBarcodesRequest($business_id, $generate_offer_barcodes_request, string $contentType = self::contentTypes['generateOfferBarcodes'][0])
    {
        ...
        if ($business_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$business_id" when calling LaasApi.generateOfferBarcodes, must be bigger than or equal to 1.');
        }
    ...
    public function getBusinessOrdersRequest($business_id, $get_business_orders_request, $page_token = null, $limit = null, string $contentType = self::contentTypes['getBusinessOrders'][0])
    {
        ...
        if ($business_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$business_id" when calling LaasApi.getBusinessOrders, must be bigger than or equal to 1.');
        }
        ...
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling LaasApi.getBusinessOrders, must be bigger than or equal to 1.');
        }
    ...
    public function getCategoryContentParametersRequest($category_id, $business_id = null, string $contentType = self::contentTypes['getCategoryContentParameters'][0])
    {
        ...
        if ($category_id <= 0) {
            throw new \InvalidArgumentException('invalid value for "$category_id" when calling LaasApi.getCategoryContentParameters, must be bigger than 0.');
        }
    ...
    public function getFulfillmentWarehousesRequest($campaign_id = null, string $contentType = self::contentTypes['getFulfillmentWarehouses'][0])
    {
        ...
        if ($campaign_id !== null && $campaign_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$campaign_id" when calling LaasApi.getFulfillmentWarehouses, must be bigger than or equal to 1.');
        }
    ...
    public function getOrderIdentifiersStatusRequest($campaign_id, $order_id, string $contentType = self::contentTypes['getOrderIdentifiersStatus'][0])
    {
        ...
        if ($campaign_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$campaign_id" when calling LaasApi.getOrderIdentifiersStatus, must be bigger than or equal to 1.');
        }
    ...
    public function getOrdersRequest($campaign_id, $order_ids = null, $status = null, $substatus = null, $from_date = null, $to_date = null, $supplier_shipment_date_from = null, $supplier_shipment_date_to = null, $updated_at_from = null, $updated_at_to = null, $dispatch_type = null, $fake = false, $has_cis = false, $only_waiting_for_cancellation_approve = false, $only_estimated_delivery = false, $buyer_type = null, $page = 1, $page_size = null, $page_token = null, $limit = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        ...
        if ($order_ids !== null && count($order_ids) > 50) {
            throw new \InvalidArgumentException('invalid value for "$order_ids" when calling LaasApi.getOrders, number of items must be less than or equal to 50.');
        }
        if ($order_ids !== null && count($order_ids) < 1) {
            throw new \InvalidArgumentException('invalid value for "$order_ids" when calling LaasApi.getOrders, number of items must be greater than or equal to 1.');
        }

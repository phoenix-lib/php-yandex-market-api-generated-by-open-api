...
**price_recommendations** | [**\OpenAPI\Client\Model\PriceRecommendationItemDTO[]**](PriceRecommendationItemDTO.md) | {% note warning \&quot;Параметр устарел и будет отключен 12.10.2026.\&quot; %}     {% endnote %}  Рекомендованные цены. | [optional]

...
| [**createDocuments()**](DbsApi.md#createDocuments) | **POST** /v1/businesses/{businessId}/offers/documents/create | Создание документов |
...
| [**deleteDocuments()**](DbsApi.md#deleteDocuments) | **POST** /v1/businesses/{businessId}/offers/documents/delete | Удаление документов |
...
| [**generateMarketingDetalizationReport()**](DbsApi.md#generateMarketingDetalizationReport) | **POST** /v1/businesses/{businessId}/reports/marketing-detalization/generate | Отчет по счету маркетинга |
...
| [**generateStocksReport()**](DbsApi.md#generateStocksReport) | **POST** /v3/businesses/{businessId}/reports/stocks/generate | Отчет по остаткам на складах партнера |
...
| [**getDocuments()**](DbsApi.md#getDocuments) | **POST** /v1/businesses/{businessId}/offers/documents | Получение документов |
...
| [**getGoodsFeedbacksUrbanads()**](DbsApi.md#getGoodsFeedbacksUrbanads) | **POST** /v1/businesses/{businessId}/goods-feedback-advertiser | Получение отзывов о товарах для рекламодателей |
...
| [**getPartnerWarehouses()**](DbsApi.md#getPartnerWarehouses) | **POST** /v3/businesses/{businessId}/warehouses | Список складов |
...
| [**getStocksOnPartnerWarehouses()**](DbsApi.md#getStocksOnPartnerWarehouses) | **POST** /v3/businesses/{businessId}/offers/stocks | Информация об остатках |
...
| [**updateDocuments()**](DbsApi.md#updateDocuments) | **POST** /v1/businesses/{businessId}/offers/documents/update | Обновление документов |
...
| [**updateStocksOnPartnerWarehouses()**](DbsApi.md#updateStocksOnPartnerWarehouses) | **POST** /v3/businesses/{businessId}/offers/stocks/update | Передача информации об остатках |
| [**updateWarehouseModelStatus()**](DbsApi.md#updateWarehouseModelStatus) | **POST** /v3/businesses/{businessId}/warehouse/models/status | Включение/выключение модели работы склада |
...
try {
    ...
    echo 'Exception when calling DbsApi->createDocuments: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DbsApi->deleteDocuments: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DbsApi->generateMarketingDetalizationReport: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DbsApi->generateStocksReport: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DbsApi->getDocuments: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DbsApi->getGoodsFeedbacksUrbanads: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DbsApi->getPartnerWarehouses: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DbsApi->getStocksOnPartnerWarehouses: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DbsApi->updateDocuments: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DbsApi->updateStocksOnPartnerWarehouses: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DbsApi->updateWarehouseModelStatus: ', $e->getMessage(), PHP_EOL;
}
```
